...
class DepartmentView extends XView<DepartmentsController> {
  DepartmentView(args, DepartmentsController controller)
            ...
            children: [
              ...
              PopupMenuButton<String>(
                ...
                onSelected: (String value) {
                  if (value == 'Open') {
                    controller.openDepartment(departement);
                  }
                  if (value == 'Delete') {
                    controller.delDepartments(departement);
                  }
                },
              )
            ],
